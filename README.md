...
| --- | --- |
| [`tutorials/`](./tutorials/) | A self-contained multi-module workspace for the official [Go tutorials](https://go.dev/doc/tutorial/), with per-example READMEs, local `go-local` wrappers, and a Docker-based no-local-Go workflow. |
