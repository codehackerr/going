...
Use each project directory as its own Go root and follow the commands in that directory's README. For the tutorial workspace, you can run the local wrapper from the repo root with commands like `.\tutorials\go-local.cmd run .\getting-started\hello`.
