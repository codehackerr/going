...
# Run Go commands with all writable state kept under .local-go in this project.
...
# Run from the script directory so relative Go workspace paths work from any caller location.
